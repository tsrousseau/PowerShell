...
Get-ADUser -Filter * -Properties SamAccountName, CN | Select-Object SamAccountName, CN | Export-Csv "C:\Temp\Results - All Users and Only Specified Fields in Domain.csv" -NoTypeInformation -Append
